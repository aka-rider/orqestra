...
func extractReport(
	...
	// Tier 1: SubmitReport submission. Keyed by agentID — the bridge resolves the
	// session internally, so this works even when res.SessionID is empty after an
	// early (report-arrival) stop.
	if sc.Reports != nil {
