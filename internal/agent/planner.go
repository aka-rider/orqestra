...
func (p *Planner) Refine(ctx context.Context, researcherDraft string) (RawPlan, harness.TokenUsage, error) {
...
func (p *Planner) RefineStreaming(ctx context.Context, researcherDraft string, stdout io.Writer) (RawPlan, harness.TokenUsage, error) {
	prompt := "Refine this researcher draft into a final implementation plan:\n\n" + researcherDraft
...
func (p *Planner) RefineWithComments(ctx context.Context, previousPlan, comments string) (RawPlan, harness.TokenUsage, error) {
...
func (p *Planner) RefineWithCommentsStreaming(ctx context.Context, previousPlan, comments string, stdout io.Writer) (RawPlan, harness.TokenUsage, error) {
	prompt := fmt.Sprintf("Revise this plan based on the reviewer's comments:\n\n## Current Plan\n\n%s\n\n## Reviewer Comments\n\n%s", previousPlan, comments)
	result, err := p.runner.RunStreaming(ctx, prompt, p.cfg.SystemPrompt, stdout)
	if err != nil {
...
func (p *Planner) parsePlanResult(result harness.RunResult) (RawPlan, harness.TokenUsage, error) {
