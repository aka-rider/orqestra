...
// buildSpecArgs, appendAgentsArg, and mergeInlineMCP live in spec_args.go.
// buildEnvFromSpec and buildModelEnvFromSpec live in env.go (J22: the real
// env builder, not a throwaway ClaudeCLI standing in for one).
