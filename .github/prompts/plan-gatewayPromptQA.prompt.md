...
## Phase 0: Golden Corpus — 50 Human-Authored Cases

NOT Opus-generated. Human-written. Ground truth must be inarguable.
...
If depth_score hasn't improved > 2% over the last 5 runs AND prompt_hash has changed each time → print: _"Quality plateau. Last 5 prompt changes had no measurable effect."_
